<nav class="navbar fixed-top navbar-expand-lg" style="transition: top 0.2s ease-in-out">
    <div class="container-fluid px-2 px-sm-3 px-md-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse bg-light" id="navbarItems">
            <div class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                <a class="nav-link {{ Route::is('book.*') ? 'active' : '' }}" href="{{ route('book.index') }}">Buku</a>
                <a class="nav-link {{ Route::is('page.about') ? 'active' : '' }}" href="{{ route('page.about') }}">List Anggota</a>
            </div>
            ...
            <div class="navbar-nav ms-auto my-2 my-lg-0">
                @auth
                    <div class="nav-item dropdown bg-light">
                        <div class="nav-link dropdown-toggle" role="button" id="profileMenu" data-bs-toggle="dropdown" aria-expanded="false">
                            <img class="rounded-circle" src="https://rekreartive.com/wp-content/uploads/2018/11/Logo-UMN-Universitas-Multimedia-Nusantara-Original.png" alt="Foto Profil Saya" height="30px">
                            {{ Auth::user()->name }}
                        </div>

                        <div class="dropdown-menu dropdown-menu-light dropdown-menu-end col-sm-6 col-md-4" aria-labelledby="profileMenu">
                ...
                @else
                    ...
                    <a class="nav-link {{ Route::is('auth.register') ? 'active' : '' }}" href="{{ route('auth.register') }}">Register</a>
                @endauth
            </div>
        </div>
    </div>
