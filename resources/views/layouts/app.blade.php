...
<head>
    ...
    {{-- SweetAlert2 --}}
    <!-- <link href="https://cdn.jsdelivr.net/npm/@sweetalert2/theme-dark@5.0.10/light.min.css" rel="stylesheet" integrity="sha256-7+hrq8vT8o6TJNVs6aQ+CMsxTjjv+XgqTOTmaC0/FF4=" crossorigin="anonymous"> -->
