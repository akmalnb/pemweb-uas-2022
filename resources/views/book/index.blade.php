...
@section('styles')
    ...
    <style type="text/css">
        ...
        .select2-results__option[aria-selected="true"] {
            background-color: #f0978d !important;
        }
...
@section('main-container')
        ...
        <div class="col col-sm-8 col-md-6 col-lg-5">
            <form action="{{ route('book.index') }}" method="GET">
                ...
                <div class="input-group">
                    <input type="search" class="form-control bg-blue border-secondary text-dark" placeholder="search" name="search" value="{{ request('search') }}" />
    ...
    @if ($books->count())
        @php($imageLink = 'https://source.unsplash.com/1200x1400?food')

        <div class="card bg-danger mb-4 mb-md-5 h-100">
            <div class="position-absolute px-3 py-2" style="background-color: rgba(128, 128, 128, 0.7)">
