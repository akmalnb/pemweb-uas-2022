    ...
    <div class="row justify-content-center mt-5">
        <div class="col col-md-9 col-lg-8">
            ...
            @auth
                @if (!$book->reviews->firstWhere('reviewer_id', Auth::user()->id))
                    <form action="{{ route('review.store') }}" method="POST" class="mt-5">
                        ...
                        <div class="d-flex flex-row bg-light">
                            <img src="https://asset.kompas.com/crops/j7-t_cIY1yC4tZ59enOLqxr4FPc=/387x0:5004x3078/750x500/data/photo/2020/09/18/5f644a893ef9e.jpg" alt="{{ Auth::user()->name }}" class="rounded-circle me-3" height="50">
                ...
                @endif
            @else
                <h6 class="mt-5"><a href="{{ route('auth.login') }}" class="text-reset">Login</a> untuk memberikan ulasan</h6>
            @endauth
            ...
            @forelse ($book->reviews as $review)
                ...
                <div class="d-flex flex-row mt-5">
                    <img src="https://asset.kompas.com/crops/j7-t_cIY1yC4tZ59enOLqxr4FPc=/387x0:5004x3078/750x500/data/photo/2020/09/18/5f644a893ef9e.jpg" alt="{{ $review->reviewer->name }}" class="rounded-circle me-3" height="50">
